...
class Resnet18_MH(nn.Module):
    def __init__(self, feature_size, n_classes):
        super(Resnet18_MH, self).__init__()
        ...
        self.bn = nn.BatchNorm1d(feature_size, momentum=0.01)
        self.ReLU = nn.ReLU()
        self.fc0 = nn.Linear(feature_size, n_classes, bias=False)
        self.fc1 = nn.Linear(feature_size, n_classes, bias=False)
        self.fc2 = nn.Linear(feature_size, n_classes, bias=False)
        self.fc3 = nn.Linear(feature_size, n_classes, bias=False)
